...
describe('Create vm', () => {
    ...
    it('fills out sanbox information', () => {
        ...
        cy.get('[data-cy=sandbox_region]').click();
        cy.contains('Norway East').click();
        cy.get('[data-cy=create_actual_sandbox]').click();
    });
    ...
    it('delete vm', () => {
        cy.get('[data-cy=vm_more_actions]').click();
        cy.get('[data-cy="vm_delete"]').click();
    ...
    it('delete sandbox', () => {
        cy.get('[data-cy=sandbox_more_options]').click();
        cy.get('[data-cy=sandbox_delete]').click();
